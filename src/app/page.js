...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-12">
      <h1 className="text-5xl font-bold mb-2 text-center">Sentiment Analyzer</h1>
      <h2 className="text-2xl mb-4 text-center">A server-side Sentiment Analyzer using Next.js and transformers.js</h2>
      <input
        type="text"
